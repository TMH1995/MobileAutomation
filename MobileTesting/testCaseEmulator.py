...
driver.find_element_by_xpath("//android.widget.TextView[@bounds='[0,1616][360,2000]']").click()
#driver.find_element_by_id("com.flipkart.android:id/not_now_button").click()

#Select a laptop
price= driver.find_element_by_xpath("//android.widget.TextView[@bounds='[40,1414][249,1485]']").get_attribute("text")
